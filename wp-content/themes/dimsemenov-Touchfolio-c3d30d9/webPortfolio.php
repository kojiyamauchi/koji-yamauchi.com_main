    ...
    <main id="webPortfolio">
      ...
      <div id="WebSiteCreation" class="clearfix">
        ...
        <div class="center">
          ...
          <h3>Prime Marche.</h3>
          <p>
          <span class="myWork">Web Design / Coding / Programming / Responsive</span><br>
        ...
        <div class="left">
          <div id="fastHuntIMGWrap">
            <a href="<?php bloginfo('url'); ?>/fast-hunt/">
              <img src="<?php bloginfo('url'); ?>/wp-content/uploads/2015/04/fastHunt.png" alt="fastHunt" width="" height="" class="fastHuntIMG1"/>
              <img src="<?php bloginfo('url'); ?>/wp-content/uploads/2015/04/fastHunt2.png" alt="fastHunt" width="" height="" class="fastHuntIMG2"/>
              <img src="<?php bloginfo('url'); ?>/wp-content/uploads/2015/04/fastHunt3.png" alt="fastHunt" width="" height="" class="fastHuntIMG3"/>
              <img src="<?php bloginfo('url'); ?>/wp-content/uploads/2015/04/fastHunt4.png" alt="fastHunt" width="" height="" class="fastHuntIMG4"/>
              <img src="<?php bloginfo('url'); ?>/wp-content/uploads/2015/04/dummyFastHuntIMG.png" alt="fastHunt" width="" height="" class=""/>
            </a>
          </div>
          <h3>Fast Hunt.</h3>
